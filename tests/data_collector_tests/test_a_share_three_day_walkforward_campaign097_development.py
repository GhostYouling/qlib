...
from scripts import a_share_three_day_walkforward_campaign097 as campaign


ROOT = Path(__file__).resolve().parents[2]
PREREGISTRATION = (
    ROOT / "docs/a_share_three_day_walkforward_campaign_097_preregistration.json"
)
OUTPUT_ROOT = (
    ROOT
    / "data/experiments/short_horizon/historical_walkforward/campaign_097/walkforward"
)
...
def test_prevalue_status_and_boundaries_remain_closed() -> None:
    ...
    assert result["campaign_id"] == "a_share_three_day_walkforward_campaign_097"
