...
from scripts import a_share_three_day_walkforward_campaign078 as campaign


ROOT = Path(__file__).resolve().parents[2]
FREEZE = ROOT / "docs/a_share_three_day_walkforward_campaign_078_development_implementation_freeze_20260806.json"
...
def test_development_preregistration_bindings_and_single_trial_catalog() -> None:
    ...
    assert digest == "766b1ffd59f94d6adf84526c8c707a593a5a43dc9081223a5cfa7099ad6d032b"
...
def test_predevelopment_status_has_zero_ledger_and_closed_stress() -> None:
    ...
    assert status["campaign_id"] == "a_share_three_day_walkforward_campaign_078"
...
def test_development_implementation_freeze_is_live() -> None:
    ...
    assert record["status"] == "frozen_before_campaign078_2019_2023_development_return_read"
