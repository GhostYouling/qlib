...
from scripts import a_share_three_day_walkforward_campaign063_empty_partition_repair as repair
...
def test_wrong_empty_schema_still_delegates_and_fails_closed() -> None:
    ...
    with pytest.raises(repair.core.Campaign063FeatureError, match="unexpected raw columns"):
