...
from scripts import a_share_three_day_walkforward_campaign091 as campaign


ROOT = Path(__file__).resolve().parents[2]
OUTPUT_ROOT = (
    ROOT
    / "data/experiments/short_horizon/historical_walkforward/campaign_091/walkforward"
)
PREREGISTRATION_SHA256 = (
    "cd69813bd2d39329cbea02cf79cdeb43aff87ddededef2913ca121b90a600a07"
)
...
def test_prevalue_status_and_boundaries_remain_closed() -> None:
    ...
    assert result["campaign_id"] == "a_share_three_day_walkforward_campaign_091"
