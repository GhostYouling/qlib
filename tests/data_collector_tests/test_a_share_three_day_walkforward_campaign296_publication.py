...
def test_campaign296_handoff_is_latest_and_external_data_change_is_excluded() -> None:
    handoff = (
    ...
    assert "截至 Campaign296" in handoff
    assert "a_share_three_day_strategy_handoff_20260825_campaign296.md" in handoff
    assert "Campaign297" in handoff
    assert "168/149" in handoff
