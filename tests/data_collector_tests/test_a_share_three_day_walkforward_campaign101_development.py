...
PREREGISTRATION = (
    ROOT / "docs/a_share_three_day_walkforward_campaign_101_preregistration_v2.json"
)


def test_frozen_runner_identity_and_compact_manifest() -> None:
    assert campaign.ADMITTED_FACTOR == (
        "full_numeric_library_directional_lower_quartile_consensus_129f"
    )
    ...
    assert campaign.EXPECTED_ELIGIBLE_ROWS == 1_327_637
