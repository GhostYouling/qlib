...
from scripts import a_share_three_day_walkforward_campaign092 as campaign


ROOT = Path(__file__).resolve().parents[2]
PREREGISTRATION = (
    ROOT / "docs/a_share_three_day_walkforward_campaign_092_preregistration_v2.json"
)
OUTPUT_ROOT = (
    ROOT
    / "data/experiments/short_horizon/historical_walkforward/campaign_092/walkforward"
)
PREREGISTRATION_SHA256 = (
    "7a357f27278699e5b0c2450cfa1127c3d1c524f28246f6239b5267f74d209dd0"
)


def test_preregistration_bindings_and_single_trial_catalog() -> None:
    report = bindings.validate_record(PREREGISTRATION)
...
def test_prevalue_status_and_boundaries_remain_closed() -> None:
    ...
    assert result["campaign_id"] == "a_share_three_day_walkforward_campaign_092"
