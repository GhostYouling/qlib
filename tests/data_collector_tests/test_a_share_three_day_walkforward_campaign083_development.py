...
FREEZE = (
    ROOT
    / "docs/a_share_three_day_walkforward_campaign_083_development_implementation_freeze_20260806.json"
)
...
def test_development_implementation_freeze_is_live() -> None:
    ...
    assert (
        record["status"]
        == "frozen_before_campaign083_2019_2023_development_return_read"
    )
