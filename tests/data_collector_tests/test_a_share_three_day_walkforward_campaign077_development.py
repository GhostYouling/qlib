...
from scripts import a_share_three_day_walkforward_campaign077 as campaign


ROOT = Path(__file__).resolve().parents[2]
FREEZE = ROOT / "docs/a_share_three_day_walkforward_campaign_077_development_implementation_freeze_20260806.json"
...
def test_development_preregistration_bindings_and_single_trial_catalog() -> None:
    ...
    assert digest == "7390d04bf46e57b637873ac754a7dedb3523baa6f1b4c99f198b291c643f2d94"
...
def test_predevelopment_status_has_zero_ledger_and_closed_stress() -> None:
    ...
    assert status["campaign_id"] == "a_share_three_day_walkforward_campaign_077"
...
def test_development_implementation_freeze_is_live() -> None:
    ...
    assert record["status"] == "frozen_before_campaign077_2019_2023_development_return_read"
