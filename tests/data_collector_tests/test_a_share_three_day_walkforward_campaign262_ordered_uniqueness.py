...
from scripts import (
    a_share_three_day_walkforward_campaign262_ordered_uniqueness as audit,
)
...
def test_candidate_panel_rejects_out_of_range_values() -> None:
    for value in (-0.01, 1.01):
        ...
        with pytest.raises(audit.Campaign262OrderedUniquenessError):
...
def test_output_path_is_campaign_scoped() -> None:
    assert "campaign_262/uniqueness" in str(audit.OUTPUT_PATH)
