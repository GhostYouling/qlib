...
from scripts import (
    a_share_three_day_walkforward_campaign119_coverage_recovery as recovery,
)
...
def test_coverage_recovery_preserves_exact_gate_and_no_return_output() -> None:
    ...
    assert recovery.audit.candidate.NUMERIC_COMPARATOR_COUNT == 136
    assert recovery.audit.OUTPUT_PATH.name == "campaign119_coverage_audit.json"
