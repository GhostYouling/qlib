...
from scripts import a_share_three_day_walkforward_campaign094 as campaign

ROOT = Path(__file__).resolve().parents[2]
PREREGISTRATION = (
    ROOT / "docs/a_share_three_day_walkforward_campaign_094_preregistration.json"
)
OUTPUT_ROOT = (
    ROOT
    / "data/experiments/short_horizon/historical_walkforward/campaign_094/walkforward"
)
PREREGISTRATION_SHA256 = (
    "57309853b10a1047384f536caeb486f1899d12ce8a10d91aa5db5dbe7b8b6564"
)
...
def test_prevalue_status_and_boundaries_remain_closed() -> None:
    ...
    assert result["campaign_id"] == "a_share_three_day_walkforward_campaign_094"
