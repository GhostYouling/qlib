...
from scripts import (
    a_share_three_day_walkforward_campaign261_features_recovery as recovery,
)
...
def test_recovery_preserves_candidate_value_exactly() -> None:
    ...
    original, _ = base.extract_amount_lorenz_gini(raw, symbol="SH600000")
    recovered, _ = recovery.extract_amount_lorenz_gini(raw, symbol="SH600000")
...
def test_recovery_adds_exact_inherited_support_counters() -> None:
    ...
    amounts[10] = 0.0
    _, quality = recovery.extract_amount_lorenz_gini(_raw(amounts), symbol="SH600000")
