"""Pre-return tests for the single frozen Campaign069 walk-forward trial."""
...
import scripts.a_share_three_day_walkforward_campaign069 as campaign


REPO_ROOT = Path(__file__).resolve().parents[2]
PREREGISTRATION_SHA256 = (
    "b73734fcaaee6140084de184125a98b43c3735b57ce92ab68e333badd4ea08cc"
)
AUDIT = (
    REPO_ROOT
    / "data/experiments/short_horizon/historical_walkforward/campaign_069/no_return/"
    "20260805T195018Z_campaign069_no_return_audit.json"
)


def test_campaign069_preregistration_loads_exact_single_trial() -> None:
...
def test_campaign069_inherits_exact_three_folds_and_survivor_gates() -> None:
...
def test_campaign069_no_return_audit_is_admissible_and_return_closed() -> None:
    ...
    assert hashlib.sha256(AUDIT.read_bytes()).hexdigest() == (
        "1f05b0943a58e8414c898113d2e0db7b58f703d076d593f9f6c36fd6bc2df6d9"
    )
    assert audit["status"] == (
    ...
    assert uniqueness["comparison_factor_count"] == 99
...
def test_campaign069_stress_is_closed_before_development_survivor_freeze() -> None:
...
def test_campaign069_development_preregistration_bindings_pass() -> None:
    result = subprocess.run(
        [
            sys.executable,
            "-m",
            ...
            "docs/a_share_three_day_walkforward_campaign_069_preregistration.json",
        ],
        cwd=REPO_ROOT,
        check=True,
        capture_output=True,
