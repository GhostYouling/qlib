...
from scripts import a_share_three_day_walkforward_campaign090 as campaign

ROOT = Path(__file__).resolve().parents[2]
OUTPUT_ROOT = (
    ROOT
    / "data/experiments/short_horizon/historical_walkforward/campaign_090/walkforward"
)
PREREGISTRATION_SHA256 = (
    "df921f1d34d82b11aeb2d698d79a3e97851010cb9053287deb74bf97752844b7"
)
...
def test_prevalue_status_and_boundaries_remain_closed() -> None:
    ...
    assert result["campaign_id"] == "a_share_three_day_walkforward_campaign_090"
