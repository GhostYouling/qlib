...
from scripts import a_share_three_day_walkforward_campaign060_empty_partition_repair as repair
...
def test_wrong_column_empty_frame_delegates_and_fails() -> None:
    ...
    with pytest.raises(core.Campaign060FeatureError, match="unexpected raw columns"):
...
def test_nonempty_frame_delegates_to_original() -> None:
    ...
    with pytest.raises(core.Campaign060FeatureError, match="241 rows"):
        repair.extract_profiles_compat(raw, symbol="SH600485")
