#!/usr/bin/env python3
"""Run the exact one-trial Campaign078 historical walk-forward campaign."""
...
ADMITTED_FACTOR = "intraday_amount_local_peak_density_238p"
FROZEN_TRIAL_ID = "wf078_intraday_amount_local_peak_density_238p_single_higher"
DEFAULT_PREREGISTRATION = REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_078_preregistration.json"
...
for _old, _new in (
    ("Campaign074", "Campaign078"),
    ("campaign074", "campaign078"),
    ("campaign_074", "campaign_078"),
    ("wf074", "wf078"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign078_generated",
}
...
Campaign078Error = _generated["Campaign078Error"]
