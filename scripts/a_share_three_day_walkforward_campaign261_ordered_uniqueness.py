#!/usr/bin/env python3
"""Run Campaign261's frozen all-142 ordered no-return uniqueness audit."""
...
for _old, _new in (
    ...
    (
        ...
        "3076716c638735db0b5c39d11593680d5ea74199c0960b7c3c1c8a6bce111501",
    ),
    (
        "235289d3151eee543282c502fe40ac3d4986663fc00a777f4b3dcbb11c01f01b",
        "cdb7c764d36c04d2643379e52fef79fff8fdc5b144f14be25724652cec385916",
    ),
    (
        "36bab509de3b8a012033b4591a5efa942e57b01178f099cd48cbb699267ca267",
        "7d9c6de6fe3b93cd7f66ee3ac1b5b8a835543aa277ef8d37f4f7f866e52cce4d",
    ),
    (
        "9ea1ebe6aad4867ce76d4fbc52fe46c80f5a3fca3096aa6e74a5e9c8292f4931",
        "8e5b64004652fbee8daa0605739698a0a7675f2a29cb8c32c537641965bc8bc5",
    ),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign261_ordered_uniqueness_generated",
}
exec(compile(_source, str(BASE_RUNNER), "exec"), _generated)  # noqa: S102

Campaign261OrderedUniquenessError = _generated["Campaign261OrderedUniquenessError"]
