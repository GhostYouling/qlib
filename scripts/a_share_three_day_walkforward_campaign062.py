#!/usr/bin/env python3
"""Run the exact one-trial Campaign062 historical walk-forward campaign."""
...
ADMITTED_FACTOR = "quarterly_announcement_peer_crowding_sparsity"
FROZEN_TRIAL_ID = (
    "wf062_quarterly_announcement_peer_crowding_sparsity_single_higher"
)
DEFAULT_PREREGISTRATION = (
    REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_062_preregistration.json"
)
...
for _old, _new in (
    ("Campaign056", "Campaign062"),
    ("campaign056", "campaign062"),
    ("campaign_056", "campaign_062"),
    ("wf056", "wf062"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign062_generated",
}
...
Campaign062Error = _generated["Campaign062Error"]
