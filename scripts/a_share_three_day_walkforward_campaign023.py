#!/usr/bin/env python3
"""Run the single frozen Campaign023 three-session walk-forward trial.

Campaign023 reuses the byte-bound Campaign018 orchestration and unchanged
...
ADMITTED_FACTOR = "intraday_range_boundary_translation_coherence_238p"
...
for _old, _new in (
    ("Campaign018", "Campaign023"),
    ("campaign018", "campaign023"),
    ("campaign_018", "campaign_023"),
    ("wf018", "wf023"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign023_generated",
}
exec(compile(_source, str(CAMPAIGN018_RUNNER), "exec"), _generated)

base = _generated["base"]
Campaign023Error = _generated["Campaign023Error"]
