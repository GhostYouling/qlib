#!/usr/bin/env python3
"""Run the exact-schema one-trial Campaign050 development campaign."""
...
ADMITTED_FACTOR = "intraday_half_session_extreme_shock_reversal_completion_2h"
FROZEN_TRIAL_ID = (
    "wf050_intraday_half_session_extreme_shock_reversal_completion_2h_single_higher"
)
DEFAULT_PREREGISTRATION = (
    REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_050_preregistration_v3.json"
)
...
for _old, _new in (
    ("Campaign048", "Campaign050"),
    ("campaign048", "campaign050"),
    ("campaign_048", "campaign_050"),
    ("wf048", "wf050"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign050_v3_generated",
}
...
Campaign050Error = _generated["Campaign050Error"]
