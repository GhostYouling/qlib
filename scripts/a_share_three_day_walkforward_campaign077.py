#!/usr/bin/env python3
"""Run the exact one-trial Campaign077 historical walk-forward campaign."""
...
ADMITTED_FACTOR = "intraday_amount_clock_dispersion_240m"
FROZEN_TRIAL_ID = "wf077_intraday_amount_clock_dispersion_240m_single_higher"
DEFAULT_PREREGISTRATION = REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_077_preregistration.json"
...
for _old, _new in (
    ("Campaign074", "Campaign077"),
    ("campaign074", "campaign077"),
    ("campaign_074", "campaign_077"),
    ("wf074", "wf077"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign077_generated",
}
...
Campaign077Error = _generated["Campaign077Error"]
