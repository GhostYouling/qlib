#!/usr/bin/env python3
"""Run the single frozen Campaign037 three-session walk-forward trial.

Campaign037 reuses the byte-bound Campaign034 orchestration and unchanged
...
ADMITTED_FACTOR = "intraday_five_minute_variance_ratio_230w"
...
for _old, _new in (
    ("Campaign034", "Campaign037"),
    ("campaign034", "campaign037"),
    ("campaign_034", "campaign_037"),
    ("wf034", "wf037"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign037_generated",
}
exec(compile(_source, str(CAMPAIGN034_RUNNER), "exec"), _generated)

base = _generated["base"]
Campaign037Error = _generated["Campaign037Error"]
