#!/usr/bin/env python3
"""Run the single frozen Campaign014 three-session walk-forward trial.

Campaign014 reuses the byte-bound Campaign011 orchestration wrapper and the
...
ADMITTED_FACTOR = "intraday_global_price_range_revisit_240m"
...
for _old, _new in (
    ("Campaign011", "Campaign014"),
    ("campaign011", "campaign014"),
    ("campaign_011", "campaign_014"),
    ("wf011", "wf014"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign014_generated",
}
exec(compile(_source, str(CAMPAIGN011_RUNNER), "exec"), _generated)

base = _generated["base"]
Campaign014Error = _generated["Campaign014Error"]
