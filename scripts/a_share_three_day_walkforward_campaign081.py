#!/usr/bin/env python3
"""Run the exact one-trial Campaign081 historical walk-forward campaign."""
...
ADMITTED_FACTOR = "intraday_amount_path_efficiency_238p"
FROZEN_TRIAL_ID = "wf081_intraday_amount_path_efficiency_238p_single_higher"
DEFAULT_PREREGISTRATION = REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_081_preregistration.json"
...
for _old, _new in (
    ("Campaign074", "Campaign081"),
    ("campaign074", "campaign081"),
    ("campaign_074", "campaign_081"),
    ("wf074", "wf081"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign081_generated",
}
...
Campaign081Error = _generated["Campaign081Error"]
