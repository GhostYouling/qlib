#!/usr/bin/env python3
"""Run the exact one-trial Campaign075 historical walk-forward campaign."""
...
BASE_RUNNER_SHA256 = (
    "8677b23a3cc64150a8e0136bdc7f81f22a1c121cda0e2912771e7c588746afc0"
)
BASE_FACTOR = "intraday_terminal_bar_amount_share_240m"
ADMITTED_FACTOR = "accepted_instrument_session_youth_20s"
FROZEN_TRIAL_ID = "wf075_accepted_instrument_session_youth_20s_single_higher"
DEFAULT_PREREGISTRATION = (
    REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_075_preregistration.json"
)
...
for _old, _new in (
    ("Campaign074", "Campaign075"),
    ("campaign074", "campaign075"),
    ("campaign_074", "campaign_075"),
    ("wf074", "wf075"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign075_generated",
}
...
Campaign075Error = _generated["Campaign075Error"]
