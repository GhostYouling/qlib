#!/usr/bin/env python3
"""Run Campaign261's frozen coverage-first no-return audit."""
...
for _old, _new in (
    ("Campaign117", "Campaign261"),
    ("campaign117", "campaign261"),
    ("campaign_117", "campaign_261"),
    ("20260813", "20260816"),
    ("all_134", "all_142"),
    ("all-134", "all-142"),
    ("all 134", "all 142"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign261_no_return_audit_generated",
}
exec(compile(_source, str(BASE_AUDIT), "exec"), _generated)  # noqa: S102

Campaign261NoReturnAuditError = _generated["Campaign261NoReturnAuditError"]
