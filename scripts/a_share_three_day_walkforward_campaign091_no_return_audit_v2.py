#!/usr/bin/env python3
"""Run Campaign091's frozen no-return audit with the binding export repair."""

from __future__ import annotations

from pathlib import Path

from scripts import a_share_three_day_walkforward_campaign091_features_v2 as definitions
from scripts import a_share_three_day_walkforward_campaign091_no_return_audit as v1
...
v1._generated["AUDIT_IMPLEMENTATION_FREEZE"] = (
    REPO_ROOT
    / "docs/a_share_three_day_walkforward_campaign_091_no_return_audit_implementation_freeze_v2_20260807.json"
)
v1._generated["AUDIT_ACTIVATION_BINDING"] = (
    REPO_ROOT
    / "docs/a_share_three_day_walkforward_campaign_091_no_return_audit_activation_binding_v2_20260807.json"
)
v1._generated["TEST_PATH"] = (
    REPO_ROOT
    / "tests/data_collector_tests/test_a_share_three_day_walkforward_campaign091_no_return_audit_v2.py"
)

Campaign091NoReturnAuditError = v1._generated["Campaign091NoReturnAuditError"]
