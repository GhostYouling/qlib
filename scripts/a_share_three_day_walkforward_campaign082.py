#!/usr/bin/env python3
"""Run the exact one-trial Campaign082 historical walk-forward campaign."""
...
ADMITTED_FACTOR = "intraday_range_amount_peak_timing_alignment_240m"
FROZEN_TRIAL_ID = "wf082_intraday_range_amount_peak_timing_alignment_240m_single_higher"
DEFAULT_PREREGISTRATION = (
    REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_082_preregistration.json"
)
...
for _old, _new in (
    ("Campaign074", "Campaign082"),
    ("campaign074", "campaign082"),
    ("campaign_074", "campaign_082"),
    ("wf074", "wf082"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign082_generated",
}
...
Campaign082Error = _generated["Campaign082Error"]
