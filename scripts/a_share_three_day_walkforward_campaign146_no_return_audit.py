#!/usr/bin/env python3
"""Run Campaign146's frozen coverage-first no-return audit."""
...
for _old, _new in (
    ("Campaign117", "Campaign146"),
    ("campaign117", "campaign146"),
    ("campaign_117", "campaign_146"),
    ("20260813", "20260814"),
    ("all_134", "all_141"),
    ("all-134", "all-141"),
    ("all 134", "all 141"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign146_no_return_audit_generated",
}
exec(compile(_source, str(BASE_AUDIT), "exec"), _generated)

Campaign146NoReturnAuditError = _generated["Campaign146NoReturnAuditError"]
