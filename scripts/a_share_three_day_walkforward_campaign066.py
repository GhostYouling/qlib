#!/usr/bin/env python3
"""Run the exact one-trial Campaign066 historical walk-forward campaign."""
...
ADMITTED_FACTOR = "quarterly_quality_rank_balance_3f"
FROZEN_TRIAL_ID = "wf066_quarterly_quality_rank_balance_3f_single_higher"
DEFAULT_PREREGISTRATION = (
    REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_066_preregistration.json"
)
...
for _old, _new in (
    ("Campaign056", "Campaign066"),
    ("campaign056", "campaign066"),
    ("campaign_056", "campaign_066"),
    ("wf056", "wf066"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign066_generated",
}
...
Campaign066Error = _generated["Campaign066Error"]
