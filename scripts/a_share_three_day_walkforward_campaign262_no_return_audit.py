#!/usr/bin/env python3
"""Run Campaign262's frozen coverage-first no-return audit."""
...
for _old, _new in (
    ("Campaign117", "Campaign262"),
    ("campaign117", "campaign262"),
    ("campaign_117", "campaign_262"),
    ("20260813", "20260816"),
    ("all_134", "all_142"),
    ("all-134", "all-142"),
    ("all 134", "all 142"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign262_no_return_audit_generated",
}
exec(compile(_source, str(BASE_AUDIT), "exec"), _generated)  # noqa: S102

Campaign262NoReturnAuditError = _generated["Campaign262NoReturnAuditError"]
