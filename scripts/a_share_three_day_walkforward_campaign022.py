#!/usr/bin/env python3
"""Run the single frozen Campaign022 three-session walk-forward trial.

Campaign022 reuses the byte-bound Campaign018 orchestration and unchanged
...
ADMITTED_FACTOR = "intraday_intrabar_close_location_pressure_240m"
...
for _old, _new in (
    ("Campaign018", "Campaign022"),
    ("campaign018", "campaign022"),
    ("campaign_018", "campaign_022"),
    ("wf018", "wf022"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign022_generated",
}
exec(compile(_source, str(CAMPAIGN018_RUNNER), "exec"), _generated)

base = _generated["base"]
Campaign022Error = _generated["Campaign022Error"]
