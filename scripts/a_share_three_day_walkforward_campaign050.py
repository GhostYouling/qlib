#!/usr/bin/env python3
"""Run the one frozen Campaign050 three-session development trial."""
...
DEFAULT_PREREGISTRATION = (
    REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_050_preregistration.json"
)
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign050_generated",
}
