#!/usr/bin/env python3
"""Run the exact one-trial Campaign076 historical walk-forward campaign."""
...
ADMITTED_FACTOR = "intraday_peak_amount_bar_recency_240m"
FROZEN_TRIAL_ID = "wf076_intraday_peak_amount_bar_recency_240m_single_higher"
DEFAULT_PREREGISTRATION = REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_076_preregistration.json"
...
for _old, _new in (
    ("Campaign074", "Campaign076"),
    ("campaign074", "campaign076"),
    ("campaign_074", "campaign_076"),
    ("wf074", "wf076"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign076_generated",
}
...
Campaign076Error = _generated["Campaign076Error"]
