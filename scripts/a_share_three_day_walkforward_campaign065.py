#!/usr/bin/env python3
"""Run the exact one-trial Campaign065 historical walk-forward campaign."""
...
ADMITTED_FACTOR = "intraday_range_weak_order_time_reversal_divergence_236t"
FROZEN_TRIAL_ID = (
    "wf065_intraday_range_weak_order_time_reversal_divergence_236t_single_higher"
)
DEFAULT_PREREGISTRATION = (
    REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_065_preregistration.json"
)
...
for _old, _new in (
    ("Campaign056", "Campaign065"),
    ("campaign056", "campaign065"),
    ("campaign_056", "campaign_065"),
    ("wf056", "wf065"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign065_generated",
}
...
Campaign065Error = _generated["Campaign065Error"]
