#!/usr/bin/env python3
"""Run the exact one-trial Campaign061 historical walk-forward campaign."""
...
ADMITTED_FACTOR = "intraday_day_over_day_realized_variance_stability_238b"
FROZEN_TRIAL_ID = (
    "wf061_intraday_day_over_day_realized_variance_stability_238b_single_higher"
)
DEFAULT_PREREGISTRATION = (
    REPO_ROOT / "docs/a_share_three_day_walkforward_campaign_061_preregistration.json"
)
...
for _old, _new in (
    ("Campaign056", "Campaign061"),
    ("campaign056", "campaign061"),
    ("campaign_056", "campaign_061"),
    ("wf056", "wf061"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign061_generated",
}
...
Campaign061Error = _generated["Campaign061Error"]
