#!/usr/bin/env python3
"""Run the single frozen Campaign024 three-session walk-forward trial.

Campaign024 reuses the byte-bound Campaign018 orchestration and unchanged
...
ADMITTED_FACTOR = "intraday_directional_range_response_coupling_238p"
...
for _old, _new in (
    ("Campaign018", "Campaign024"),
    ("campaign018", "campaign024"),
    ("campaign_018", "campaign_024"),
    ("wf018", "wf024"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign024_generated",
}
exec(compile(_source, str(CAMPAIGN018_RUNNER), "exec"), _generated)

base = _generated["base"]
Campaign024Error = _generated["Campaign024Error"]
