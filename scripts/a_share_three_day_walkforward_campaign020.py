#!/usr/bin/env python3
"""Run the single frozen Campaign020 three-session walk-forward trial.

Campaign020 reuses the byte-bound Campaign018 orchestration and unchanged
...
ADMITTED_FACTOR = "quarterly_announcement_freshness_60s"
...
for _old, _new in (
    ("Campaign018", "Campaign020"),
    ("campaign018", "campaign020"),
    ("campaign_018", "campaign_020"),
    ("wf018", "wf020"),
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign020_generated",
}
exec(compile(_source, str(CAMPAIGN018_RUNNER), "exec"), _generated)

base = _generated["base"]
Campaign020Error = _generated["Campaign020Error"]
