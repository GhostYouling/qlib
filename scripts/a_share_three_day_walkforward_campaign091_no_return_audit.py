#!/usr/bin/env python3
"""Run Campaign091's frozen coverage-first no-return uniqueness audit."""
...
for _old, _new in (
    ...
    (
        ...
        "a_share_three_day_walkforward_campaign090_no_return_audit as c88_audit",
    ),
    ("3ab55cc6f61bebb6713aeacb9e54125c20183295b862717617be0b13c9d0a204", "1caf67c6b65947e4407f3064f732bf33a7595b9df977c8d62236c321c91e4541"),
    ("c4f8794f42f1fffe2847ade875232827c8ca532a7fd75dd1123686c41456655a", "e179abf89f0ef956e22508c00ca198a6cf612b25700c5b8612f1d3d6d383e6fa"),
    ("3d7fc48e6cbe0fae14300ba9d09004f72e0d11a9570c59f4550fa9c42f0f478a", "5f5fbdffeef54d0d648e8a7d36ffbdc12156142a61472720eae161b29f2cdab3"),
    ("EXPECTED_ELIGIBLE_ROWS = 1_327_577", "EXPECTED_ELIGIBLE_ROWS = 1_328_350"),
    ("EXPECTED_COMPARISON_COUNT = 118", "EXPECTED_COMPARISON_COUNT = 120"),
    ("EXPECTED_COMPLETE_DEFINITION_COUNT = 120", "EXPECTED_COMPLETE_DEFINITION_COUNT = 122"),
    ("len(comparisons) != 117", "len(comparisons) != 119"),
    ("first 117 comparison order changed", "first 119 comparison order changed"),
    ('receipts["campaign088_compact_snapshot"]', 'receipts["campaign090_compact_snapshot"]'),
    ('receipts.pop("all_117_sources_loaded_in_frozen_order", None)', 'receipts.pop("all_119_sources_loaded_in_frozen_order", None)'),
    ('receipts["all_118_sources_loaded_in_frozen_order"] = True', 'receipts["all_120_sources_loaded_in_frozen_order"] = True'),
    (
        "c88_audit.c87_audit._compact_snapshot_comparison",
        "c88_audit.c88_audit.c88_audit.c87_audit._compact_snapshot_comparison",
    ),
):
...
_generated: dict[str, Any] = {
    ...
    "__name__": "a_share_three_day_walkforward_campaign091_no_return_generated",
}
exec(compile(_source, str(BASE_RUNNER), "exec"), _generated)

Campaign091NoReturnAuditError = _generated["Campaign091NoReturnAuditError"]
