#!/usr/bin/env python3
"""Append Campaign263's frozen-byte Black exemption."""
...
FAILURE = (
    ROOT
    / "docs/a_share_three_day_walkforward_campaign_263_frozen_black_exemption_20260816.json"
)
OUTPUT = PRIOR.with_name("research_attempt_ledger_v13.json")
...
def main() -> int:
    ...
    if (
        ...
        raise RuntimeError("Campaign263 ledger v12 changed")
    entry: dict[str, Any] = {
        "ordinal": 34,
        "attempt_id": "campaign263_infrastructure_025",
        "attempt_class": "infrastructure_failure",
        "phase": "terminal_static_validation",
        "status": "black_check_five_frozen_scientific_files_would_reformat_bytes_preserved",
    ...
    value = {
        ...
        "status": "campaign263_terminal_frozen_black_exemption_twenty_five_infrastructure_failures_zero_survivors_stress_closed",
        "recorded_at": "2026-08-16T14:41:00Z",
        ...
        "delta_entries": [entry],
        "effective_entry_count": 34,
        "effective_infrastructure_failure_attempt_count": 25,
